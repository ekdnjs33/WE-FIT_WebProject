...
<html>
  ...
  <body style="margin:8px; background:#f5c94c">
    <div id="top">
      ...
      <br><img src="../img/logo.png" alt="we fit 로고" width="7%" align="center"> 기본 3코스(Basic 3)</a> <!--기본 1코스(Basic 1)로 변경 다원-->
      <a href="Basic3.php?<?php echo "player=$player";?>" style="position: absolute; right: 0; margin-right:70px;"><input style="margin-top:50px" class="make" type="button" value="시작하기"/></a>
    </div>
